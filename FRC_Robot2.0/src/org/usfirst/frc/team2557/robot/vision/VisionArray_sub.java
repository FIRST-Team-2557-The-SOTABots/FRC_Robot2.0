...
//	coveredElements = 0;
	...
	public double findHeights2(int n){
		heights = table2.getNumberArray("height", heights);
			for(double height: heights){
				SmartDashboard.putNumber("height", height);
				heightDataCount++;
				SmartDashboard.putNumber("HeightsDataCount", heights.length);
	...
	public double findWidths2(int n){
		widths = table2.getNumberArray("width", widths);
	...
	public double findCenterXs2(int n){
			centerXs = table2.getNumberArray("centerX", heights);
	...
	public double findCenterYs2(int n){
			centerYs = table2.getNumberArray("centerY", centerYs);
 ...
 */
	...
	public void simpleInterpretation2(){
		if(centerXs != null){
		if(centerXs[0] > 197 && centerXs[0] < 201 && widths[0] > 37 && widths[0] < 41){
			boolean goodToShoot = true;
			SmartDashboard.putBoolean("Shoot", goodToShoot);
		}
		}
	}
