...
public class Chassis_sub extends Subsystem {
    ...
    public void arcadeDrive_gear(){
    	robotDrive.arcadeDrive(-Robot.oi.getGamepad(0).getRawAxis(0) *x,
    			Robot.oi.getGamepad(0).getRawAxis(1) *x);
    }
    public void arcadeDrive_fuel(){
    	robotDrive.arcadeDrive(-Robot.oi.getGamepad(1).getRawAxis(0) *x,
    			-Robot.oi.getGamepad(1).getRawAxis(1) *x);
    }
    public void tankDrive_gear(){
    	robotDrive.tankDrive(-Robot.oi.getGamepad(0).getRawAxis(0) *x,
