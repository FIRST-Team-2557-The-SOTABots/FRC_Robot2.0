...
//    	addSequential(new SensorReset_autoCmd(3)); //Reset the encoders to zero
//    	addSequential(new TimedDrive(.25, false, 0)); //Allow time to reset the encoders
//    	addSequential(new EncoderDrive_cmd(20.34, 20.11 , true, .9)); //Drive away from hopper
//
//    	addSequential(new GyroDrive_cmd(90, .85)); //Turn right to face the general direction of the loading station
//    	
//    	addSequential(new SensorReset_autoCmd(3)); //Reset the encoders to zero
//    	addSequential(new TimedDrive(.25, false, 0)); //Pause to allow time for the encoders to reset
