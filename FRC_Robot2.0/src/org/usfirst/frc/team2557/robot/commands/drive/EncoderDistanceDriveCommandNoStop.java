...
public class EncoderDistanceDriveCommandNoStop extends Command {
	private double speed;
	private double distance;

    public EncoderDistanceDriveCommandNoStop(double s, double d) {
    ...
    protected void execute() {
    	Robot.DriveSubsystem.DiffDrive(speed*1.0, RobotMap.Gyro1.getAngle()*0.1);
    }
