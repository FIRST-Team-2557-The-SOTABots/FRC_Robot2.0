 ...
 *
 */
public class EncoderDriveCommand5 extends Command {
	
	private double speed;
	private double rotation;

    public EncoderDriveCommand5(double s, double r) {
    ...
    protected boolean isFinished() {
    	if((-RobotMap.Left2.getSensorCollection().getQuadraturePosition()/10 > 4515) && (RobotMap.Right2.getSensorCollection().getQuadraturePosition()/10 > 4760)) {
