 ...
 *
 */
public class EncoderDriveCommand6 extends Command {
	
	private double speed;
	private double rotation;

    public EncoderDriveCommand6(double s, double r) {
    ...
    protected boolean isFinished() {
    	if((-RobotMap.Left2.getSensorCollection().getQuadraturePosition()/10 > 3260) && (RobotMap.Right2.getSensorCollection().getQuadraturePosition()/10 > 3530)) {
