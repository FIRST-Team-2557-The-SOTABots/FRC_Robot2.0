 ...
 *
 */
public class EncoderDriveCommand1 extends Command {
	
	private double speed;
	private double rotation;

    public EncoderDriveCommand1(double s, double r) {
    ...
    protected boolean isFinished() {
    	if((-RobotMap.Left2.getSensorCollection().getQuadraturePosition()/10 > 5800) && (RobotMap.Right2.getSensorCollection().getQuadraturePosition()/10 >5950)) {
